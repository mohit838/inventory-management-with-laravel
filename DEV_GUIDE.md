...
```bash
docker exec -it inventory_app php artisan config:publish cors
docker exec -it inventory_app php artisan config:clear
docker exec -it inventory_app php artisan config:cache
```
